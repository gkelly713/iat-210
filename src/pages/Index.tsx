      ...
      <footer className="bg-slate-800 text-white py-6">
        <div className="container text-center">
          <p className="text-sm text-slate-300">
            © {new Date().getFullYear()} Beyond Entertainment: How Pokémon Go's Augmented Reality Design Promotes Mental Well-being in the Digital Age
          </p>
        </div>
      </footer>
    </div>;
