  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <Section ref={introRef} id="introduction" title="Introduction" index={0}>
          <ImageDisplay src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800" alt="A person holding a smartphone while outdoors, suggesting AR gaming" position="right" size="medium" />
        ...
        <Section ref={wayfindingRef} id="wayfinding" title="Wayfinding" index={2}>
          ...
          <ImageDisplay src="https://images.unsplash.com/photo-1469474968028-56623f02e42e" alt="Person walking outdoors in a park with smartphone" position="right" size="medium" />
        ...
        <Section ref={progressionRef} id="progression" title="Progression" index={3}>
          ...
          <ImageDisplay src="https://images.unsplash.com/photo-1527307833176-e3a5d5bb4573" alt="Group of people gathered outdoors, looking at their phones" position="left" size="medium" />
        ...
        <Section ref={conclusionRef} id="conclusion" title="Conclusion" index={4}>
          <ImageDisplay src="https://images.unsplash.com/photo-1552820728-8b83bb6b773f" alt="Person sitting outdoors with smartphone, enjoying nature" position="center" size="medium" />
